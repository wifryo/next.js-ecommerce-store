export const miscellaniaDatabase = [
  ...
  },
  {
    ...
    description: `the incursion of the eldritch horrors of the late 23nd century was no laughing matter - but at least it gave rise (!) to fairy dust bread. while not recommended for direct descendants of veterans of the conflict (for obvious reasons), for everyone else fairy dust bread blesses us with tranquillity like nothing else.`,
    price: '1500',
  },
  {
    id: '6',
